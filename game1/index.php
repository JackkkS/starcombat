...
<html lang = "en">
  ...
  <div id="unity-container" style = "text-align: center"; class="unity-desktop">
      ...
      <div id="unity-footer">
        ...
        <strong><div style="text-align :center;" id="unity-build-title">Tetris</div></storng>
  </br>
  </br>
  </br>
      </div>
    ...
    <script>
      ...
      var config = {
        dataUrl: buildUrl + "/Test01.data",
        frameworkUrl: buildUrl + "/Test01.framework.js",
        codeUrl: buildUrl + "/Test01.wasm",
