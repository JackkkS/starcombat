  ...
  <div style = "margin-right:100px;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>Game Rule</h3></strong>
				<br />
				<strong><h4 style = "color:#ff0000;">1. Do not advertise</h4></strong>
				
				<br />
				<strong><h4 style = "color:#ff0000;">2. Do not use bad words</h4></strong>
				
				<br />
				<strong><h4 style = "color:#ff0000;">3. Do not harass other player</h4></strong>
				
				<br />
				<strong><h4 style = "color:#ff0000;">4. Do not break Stars Combat Term of Use, Stars Combat Community Rules, Thai Law</h4></strong>
				<strong><h5 style = "color:#ff0000;">4.1 Online Dating</h4></strong>
				<strong><h5 style = "color:#ff0000;">4.2 NSFW activities</h4></strong>
