...
<html lang = "en">
	<head>
		<title>UTK Sport Club Admin</title>
		<meta charset = "utf-8" />
...
<body>
	<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		<div  class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" >UTK Sport Club ADMIN</a>
			</div>
	...
	<div class = "container-fluid">	
		<ul class = "nav nav-pills">
			...
			<li class = "active"><a href = "account.php">บัญชี</a></li>
			<li><a href = "reserve.php">การจองสนาม</a></li>
			<li><a href = "room.php">ประเภทสนามกีฬา</a></li>			
		</ul>	
	</div>
	<br />
	<div class = "container-fluid">
